            ...
            <div>
                ...
                <div className="mx-auto mt-8 max-w-3xl space-y-4 md:mt-16 px-4 md:px-0">
                    ...
                    >
                        ...
                        >
                            <span className="flex text-lg font-semibold text-black">What is AP Software Solution?</span>
                            {expandedIndex === 0 ? (
                        ...
                        {expandedIndex === 0 && (
                            <div className="px-4 pb-5 sm:px-6 sm:pb-6">
                                <p className="text-gray-500">
                                    AP Software Solutions is software development company. We're on a mission to improve the software industry by promoting remote work, fostering collaboration, and igniting innovation. Step into a world of limitless possibilities and shape the future together.
                                </p>
                            </div>
                        )}
                    </div>
                    {Array.from({ length: 4 }).map((_, i) => (
                        ...
                        >
                            ...
                            >
                                {i === 0 && (
                                    <>
                                        <span className="flex text-lg font-semibold text-black">Does your company have internship opportunities?</span>
