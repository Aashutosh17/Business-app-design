...
const Contact = () => {
    return (
        <section className="contact-area-wrapper">
            ...
            <section className="contact-us relative z-10 overflow-hidden bg-white py-20 lg:py-[120px]">
                <div className="container mx-auto">
                    <div className="-mx-4 flex flex-wrap lg:justify-between">
                        <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
                            <div className="mb-12 max-w-[570px] lg:mb-0">
                                <span className="text-sitecolor mb-4 block text-base font-semibold">Contact Us</span>
                                ...
                                <div className="mb-8 flex w-full max-w-[370px]">
                                    <div className="bg-primary text-sitecolor mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
                                    ...
                                    <div className="w-full">
                                        ...
                                        <p className="text-body-color text-base">Kathmandu, Nepal</p>
                                    </div>
                                </div>
                                <div className="mb-8 flex w-full max-w-[370px]">
                                    <div className="bg-primary text-sitecolor mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
                                    ...
                                    <div className="w-full">
                                        ...
                                        <p className="text-body-color text-base">(+977) 9861308626s</p>
                                    </div>
                                </div>
                                <div className="mb-8 flex w-full max-w-[370px]">
                                    <div className="bg-primary text-sitecolor mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
                                    ...
                                    <div className="w-full">
                                        ...
                                        <p className="text-body-color text-base">info@ap.softwares.com</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="relative rounded-lg bg-gray-100 p-8      sm:p-12">
                                <form action="https://formspree.io/f/xvonjnjk" method="POST">
                                    ...
                                    <div>
                                        <button
                                            type="submit"
                                            className="bg-sitecolor border-primary w-full rounded border p-3 text-white transition hover:bg-opacity-90"
                                        >
                                            Send Message
                                        </button>
                                    </div>
